...
nc_labels_MNIST = ncClassifier(train_images_MNIST(:,1:280),...
                               test_images_MNIST(:,281:400),...
                               train_labels_MNIST(1:280),...
                               'MNIST');
...
scoreClassifier(nc_labels_MNIST,test_labels_MNIST(281:400))
